...
<article class="container products-archive">
        ...
        <div class="filtro">
            ...
            <form class="filtro-preco">
                <div>
                    ...
                    <input required type="text" name="min_price" id="min_price" value="<?= $_GET[
                      "min_price"
                    ] ?? "" ?>">
                </div>
                <div>
                    <label for="max_price">Até R$</label>
                    <input required type="text" name="max_price" id="max_price" value="<?= $_GET[
                      "max_price"
                    ] ?? "" ?>">
                </div>
    ...
    <main>
        <?php if ($data["products"] && $data["products"][0]) { ?>
